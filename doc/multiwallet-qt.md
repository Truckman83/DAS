...
Only requiring some minor changes is das.cpp.
...
Changes to das.cpp
----------------------
das.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
