...
This mechanism has been integrated into Bitcore-Node-Das which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/daspay/insight-api-das#web-socket-api](https://github.com/daspay/insight-api-das#web-socket-api) 
* API: [https://github.com/daspay/insight-api-das#instantsend-transactions](https://github.com/daspay/insight-api-das#instantsend-transactions) 
...
By default, the Das Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Das Core daemon:
