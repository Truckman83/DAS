TOR SUPPORT IN DAS CORE
=======================

It is possible to run Das Core as a Tor hidden service, and connect to such services.
...
1. Run Das Core behind a Tor proxy
----------------------------------

The first step is running Das Core behind a Tor proxy. This will already make all
...
2. Run a Das Core hidden server
-------------------------------
...
config file):
	...
	HiddenServiceDir /var/lib/tor/dascore-service/
...
your dasd's P2P listen port (9399 by default).
	...
	-externalip=X   You can tell Das Core about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/dascore-service/hostname. Onion addresses are given
...
3. List of known Das Core Tor relays
------------------------------------
