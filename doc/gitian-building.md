...
*Setup instructions for a Gitian build of Das Core using a Debian VM or physical system.*
...
- [Building Das Core](#building-das-core)
...
Clone the git repositories for Das Core and Gitian.
...
in the Das Core repository under 'Fetch and build inputs' to install sources which require
...
To build Das Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Das Core repository.
