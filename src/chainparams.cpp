...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1509062400; 
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1511740800; 
        ...
        vSeeds.push_back(CDNSSeedData("das_node", "35.202.92.15"));
		vSeeds.push_back(CDNSSeedData("das.thecryptochat.net", "154.16.7.191"));
        ...
        // Das BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Das BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        ...
        strSporkPubKey = "047225a459304c1929440c7bd4fb9c400ab6b88ebc80be1d7a0ab12a9db0ae149651d0d32508ccfe615336ec0f302dfa7ba9c49276e317888ee4773313294a96a9";
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  50000, uint256S("000000000017288daaaba45ccda0c9542c16c6eaeef1aad164d0063268016848")),
            1506664093, // * UNIX timestamp of last checkpoint block
            67705,      // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams() {
        ...
        // Testnet Das BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Das BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        strSporkPubKey = "04942f04a811afefe1ff39e8b8528d1810e124f2b39ac843203e21cdfc8c4bf5e120886a9d16545e29dc6bbe1e821fe4720fdd110c5ff2b95411e8cb5552cc500e";
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Das BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Das BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
