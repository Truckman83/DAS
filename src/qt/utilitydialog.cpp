    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Das Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Das Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  das-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Das in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DAS, 0.1 DAS, 1 DAS and 10 DAS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://daspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://daspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Das Core is shutting down...") + "<br /><br />" +
