    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Das Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Das address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and das: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Das Core"), this);
    aboutAction->setStatusTip(tr("Show information about Das Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Das Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Das addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Das addresses"));
    ...
    openAction->setStatusTip(tr("Open a das: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Das Core help message to get a list with possible Das Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Das Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Das network", "", count));
}
...
{
    QString strTitle = tr("Das Core"); // default title
