...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DasCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DasCore
    // Mac: ~/Library/Application Support/DasCore
    // Unix: ~/.dascore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DasCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DasCore";
#else
    // Unix
    return pathRet / ".dascore";
#endif
#endif
}
